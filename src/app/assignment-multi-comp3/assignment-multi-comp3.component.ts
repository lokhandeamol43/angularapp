...
@Component({
  selector: 'app-assignment-multi-comp3',
  templateUrl: './assignment-multi-comp3.component.html',
  styleUrls: ['./assignment-multi-comp3.component.css']
})
export class AssignmentMultiComp3Component implements OnInit {
